...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MealBeta — Know Wetin To Eat" },
      { property: "og:description", content: "Smart Nigerian meal planning: budget, calories, shopping lists, and nearby restaurants." },
