  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/home" className="inline-flex items-center justify-center rounded-full bg-brand px-5 py-2.5 text-sm font-medium text-brand-foreground">
            Go to MealBeta
          </Link>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6c597372-5df9-4e81-902d-5363ea176436/id-preview-b7e07387--59a39bdc-bb46-4835-b254-02e5a8e68404.lovable.app-1783869985453.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6c597372-5df9-4e81-902d-5363ea176436/id-preview-b7e07387--59a39bdc-bb46-4835-b254-02e5a8e68404.lovable.app-1783869985453.png" },
    ],
    links: [
