      ...
      <div className="phone-shell overflow-hidden md:rounded-[36px] md:min-h-[900px] md:max-h-[900px] flex flex-col">
        ...
        <div className="flex-1 px-6 pt-4 pb-8 flex flex-col justify-between">
          ...
          <div className="mt-8 space-y-3">
            <Link to="/onboarding" className="w-full flex items-center justify-center gap-2 rounded-full bg-brand px-6 py-4 text-brand-foreground font-semibold shadow-[var(--shadow-lift)]">
              Get started <ArrowRight className="h-4 w-4" />
            </Link>
            <Link to="/home" className="w-full flex items-center justify-center gap-2 rounded-full bg-secondary px-6 py-4 text-secondary-foreground font-medium">
